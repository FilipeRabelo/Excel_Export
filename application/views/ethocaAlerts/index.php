...
<div class="page-wrap">
    ...
    <div class="main-content">
        <div class="container-fluid ">
                ...
                <div class="row align-items-end">
                    <div class="col-lg-8">
                        <div class="page-header-title">
                            <i class="ik ik-alert-octagon text-dark  bg-blue"></i>
                            <div class="d-inline">
                                <h5><?= $titulo; ?></h5>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h4 class="p-3 mb-2 bg-light text-center text-dark font-weight-bold shadow-lg p-3 mb-5 bg-info rounded">Enviando Planilha EthocaAlerts para Banco de Dados Bit Hive!</h4>
                    <hr>
                    <?php
                    ...
                    ?>
                    <form method="post" action="<?php echo base_url('EthocaAlerts/spreadsheet_import'); ?>" enctype="multipart/form-data">
